...
//		departmentMapper.insertSelective(new Department(null, "测试部"));
        ...
        //2、生成员工数据，测试员工插入
        employeeMapper.insertSelective(new Employee(null, "Jerry", "M", "Jerry@yzx.com", 1));
...
//		}
        ...
        for(int i = 0;i<1000;i++){
            ...
            mapper.insertSelective(new Employee(null,uid, "M", uid+"@yzx.com", 1));
        }
